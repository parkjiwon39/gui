...
public class JTableTest3 extends JFrame implements ActionListener{
	...
	public JTableTest3() {
		...
		txtName.setFont(new Font("굴림", Font.PLAIN, 8));
		panel.add(txtName);
		...
		txtAge.setFont(new Font("굴림", Font.PLAIN, 8));
		panel.add(txtAge);
		...
		txtGender.setFont(new Font("굴림", Font.PLAIN, 8));
		panel.add(txtGender);
		txtGender.setColumns(10);
		
		JButton btnInput = new JButton("입력");
		btnInput.setFont(new Font("굴림", Font.PLAIN, 12));
		panel.add(btnInput);
